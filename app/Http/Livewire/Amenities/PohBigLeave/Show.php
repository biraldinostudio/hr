...
class Show extends Component
{
    ...
    public function render(){
       ...
       $pohBigLeaves=PohBigLeave::query()->select('id','site_id','poh_id','day_of','active','created_at')
        ...
        return view('livewire.amenities.poh-big-leave.show',compact('pohBigLeaves'));
    }
