...
class Create extends Component
{
    ...
    public function render(){
        ...
        $employees=User::select('id','site_id','name')->where('staff','1')->whereIn('level',['employee','department_head'])->where('active','1')->get();
        return view('livewire.user.hr-head.create',compact('employees','sites'))->extends('layouts.app')->section('content');
    }
