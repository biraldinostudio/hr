...
class CreateAnnualLeaveCountersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('annual_leave_counters', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('annual_leave_counters');
    }
}
