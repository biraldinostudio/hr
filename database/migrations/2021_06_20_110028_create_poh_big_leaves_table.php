...
class CreatePohBigLeavesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('poh_big_leaves', function (Blueprint $table) {
            $table->increments('id')->index('big_lvs_id');
    ...
    {
        Schema::dropIfExists('poh_big_leaves');
    }
}
