 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
                  ...
                  <tbody>
								@forelse ($bigLeaves as $item)
                                    <tr>								
										...
										<td><a type="button" href="{{route('big-leave.edit',$item->id)}}"  title="Ubah"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp; 
									        <a type="button" wire:click="$emitTo('amenities.big-leave.delete','deleteBigLeave',{{$item->id}})" title="Hapus"><i class="fa fa-trash"></i></a>
									</td>
                                    </tr>
								@empty
									Data tidak ada!
        ...
        <p>
            Showing {{$bigLeaves->firstItem()}} to {{$bigLeaves->lastItem()}} out of {{$bigLeaves->total()}} items
        </p>
        <p>
				{{$bigLeaves->links()}}
              </div>
