 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
                  ...
                  <tbody>
								@forelse ($pohBigLeaves as $item)
                                    <tr>								
										...
										<td><a type="button" href="{{route('poh-big-leave.edit',$item->id)}}"  title="Ubah"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp; 
									        <a type="button" wire:click="$emitTo('amenities.poh-big-leave.delete','deletePohBigLeave',{{$item->id}})" title="Hapus"><i class="fa fa-trash"></i></a>
									</td>
                                    </tr>
								@empty
									Data tidak ada!
        ...
        <p>
            Showing {{$pohBigLeaves->firstItem()}} to {{$pohBigLeaves->lastItem()}} out of {{$pohBigLeaves->total()}} items
        </p>
        <p>
				{{$pohBigLeaves->links()}}
              </div>
