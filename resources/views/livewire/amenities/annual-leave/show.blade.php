 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
                  ...
                  <tbody>
								@forelse ($annualleaves as $item)
                                    <tr>								
										...
										<td><a type="button" href="{{route('annual-leave.edit',$item->id)}}"  title="Ubah"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp; 
									        <a type="button" wire:click="$emitTo('amenities.annual-leave.delete','deleteAnnualLeave',{{$item->id}})" title="Hapus"><i class="fa fa-trash"></i></a>
									</td>
                                    </tr>
								@empty
									Data tidak ada!
        ...
        <p>
            Showing {{$annualleaves->firstItem()}} to {{$annualleaves->lastItem()}} out of {{$annualleaves->total()}} items
        </p>
        <p>
				{{$annualleaves->links()}}
              </div>
