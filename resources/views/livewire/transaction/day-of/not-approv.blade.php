    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content bg-warning">
        ...
        <div class="modal-body" style="overflow: visible;">
            <p>Apakah Anda yakin? tidak menyetujui pengajuan cuti sodara <strong>{{$employee}}</strong> dengan NRP: <strong>({{$nrp}})</strong> jabatan / departemen: <strong>{{$position}} / {{$department}}</strong> job site: <b>{{$site}}</b> akan melaksanakan cuti tanggal: <strong>{{date('d M Y',strtotime($travelFromGo))}}</strong> ? <br><br> Persetujuan pengajuan cuti yang tidak disetujui tidak akan dibatalkan.<br><br> Jika Anda yakin, silahkan isi alasannya dan klik tombol <strong>Tidak Setuju</strong></p>		
