...
<div class="content-wrapper"> 
 <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pengajuan Cuti Tahunan</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('home')}}">Beranda</a></li>
              <li class="breadcrumb-item active">Pengajuan Cuti Tahunan</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-8">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Pengajuan Cuti Tahunan</h3>
              </div>
			...
			@elseif($annualLeaveStandartDay==null or $annualLeaveStandartDay=='')
				Maaf, parameter cuti tahunan untuk POH <strong>{{$pohName}}</strong> Jobsite <strong>{{$siteName}}</strong> belum diatur oleh Administrator !.
			...
			<div class="row">
				<div class="col-md-12" style="font-size:13px">
					<table>
						...
						<tr><td><strong>Potong dari Izin</strong></td><td>: @if($permissionDebtLess==null) 0 @else{{$permissionDebtLess}} @endif Hari</td></tr>							
						<tr><td><strong>Sisah Cuti Tahunan</strong></td><td>: @if($annualLeaveLess==null) 0 @else{{$annualLeaveLess}} @endif Hari</td></tr>
						<tr><td><strong>Hak Cuti Tahunan (Max)</strong></td><td>: @if($permissionDebtLess==null) 0 @else{{($annualLeaveStandartDay+$annualLeaveLess)-$permissionDebtLess}} @endif Hari</td></tr>							
				...
				<div class="row">
					<div class="col-md-6">
						...
						<label>Mulai Cuti Tahunan</label>
							  <div class="input-group date" data-provide="datepicker">
								<div class="input-group-prepend">
								  <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
								</div>
								<input wire:model="annualLeaveStartDate" type="text" id="annualLeaveStartDateId" class="form-control" onchange='Livewire.emit("selectAnnualLeaveStartDate", this.value)' placeholder="Mulai cuti ..." autocomplete="off" disabled="disabled">
							  </div>
						</div>					
					</div>
					<div class="col-md-6">
						<div class="form-group">
						<label>Selesai Cuti Tahunan</label>
							  <div class="input-group date" data-provide="datepicker">
								<div class="input-group-prepend">
								  <span class="input-group-text"><i class="far fa-calendar-alt"></i></span>
								</div>
								<input wire:model="annualLeaveEndDate" type="text" id="annualLeaveEndDateId" class="form-control" onchange='Livewire.emit("selectAnnualLeaveEndDate", this.value)' placeholder="Selesai cuti ..." autocomplete="off">
							  </div>
						</div>					
					</div>						
				</div>
