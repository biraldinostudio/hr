          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="right">
				...
				<button type="button" data-toggle="modal" data-target="#updateAllModal" class="btn btn-info btn-sm">Semua Karyawan</button>
                  </div>
                </div>
              </div>
              </div>
                  ...
                  <tbody>
								@forelse ($employees as $item)
                                    <tr>
										...
										<td>
									<a type="button" wire:click="$emitTo('user.employee.update','resetPasswordEmployee',{{$item->id}})" title="Reset Password"><i class="fa fa-lock"></i></a>
									</td>
                                    </tr>
								@empty
									Data tidak ada!
