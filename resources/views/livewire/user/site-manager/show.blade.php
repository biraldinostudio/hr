 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Peran Site Manager</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('home')}}">Beranda</a></li>
              <li class="breadcrumb-item active">Peran Site Manager</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody>
						@forelse ($employees as $item)
                            <tr>
								...
								<td>
									<a type="button" wire:click="$emitTo('user.site-manager.delete','deleteSiteManager',{{$item->id}})" title="Non Aktifkan"><i class="fa fa-ban"></i></a>
								</td>
                            </tr>
								@empty
									Data tidak ada!
