...
<script>
    $('#siteId').change(function(){
		$.get('sites/' + this.value + '/employees.json', function(employees){
			...
			$("#employeeId").append('<option>Pilih GEA Dept.Head</option>');
