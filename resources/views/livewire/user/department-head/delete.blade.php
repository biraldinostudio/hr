    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="overflow: visible;">
            <p>Apakah kamu yakin? non aktifkan <strong>({{$nrp}}) {{$employee}}</strong> yang berperan sebagai pimpinan departemen <b>{{$department}}</b> di job site <b>{{$site}}</b> di aplikasi ini ? <br><br> Jika melanjutkan proses ini, maka peran yang bersangkutan di aplikasi ini level user akan berubah menjadi level karyawan biasa tanpa merubah jabatannya.</p>
        </div>
