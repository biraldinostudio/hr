<div wire:ignore.self class="modal fade text-left" id="deleteModal" tabindex="-1"role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <form wire:submit.prevent="delete">
                <div class="modal-body">
                    <p>Apakah kamu yakin? hapus departemen "<strong>{{$name}}</strong>"" ?</p>
                </div>
