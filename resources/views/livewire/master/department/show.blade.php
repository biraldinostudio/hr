                ...
                <table class="table table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                       ...
                       <th wire:click="sortBy('name')" style="cursor:pointer;">Department @include('partials._sort-icon',['field'=>'name'])</th>
                  ...
                  <tbody>
						@forelse ($departments as $item)
                            <tr>
								...
								<td><a type="button" wire:click="$emitTo('master.department.update','updateDepartment',{{$item->id}})"  title="Ubah"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp; 
									<a type="button" wire:click="$emitTo('master.department.delete','deleteDepartment',{{$item->id}})" title="Hapus"><i class="fa fa-trash"></i></a>
								</td>
                            </tr>
						@empty
							Data tidak ada!
