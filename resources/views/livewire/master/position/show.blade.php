 <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" style="height: 460px;">
                <table class="table table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                       <th wire:click="sortBy('name')" style="cursor:pointer;">Jabatan @include('partials._sort-icon',['field'=>'name'])</th>					
                  ...
                  <tbody>
						@forelse ($positions as $item)
                            <tr>
								...
								<td><a type="button" wire:click="$emitTo('master.position.update','updatePosition',{{$item->id}})"  title="Ubah"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp; 
									<a type="button" wire:click="$emitTo('master.position.delete','deletePosition',{{$item->id}})" title="Hapus"><i class="fa fa-trash"></i></a>
								</td>
                            </tr>
						@empty
							Data tidak ada!
        ...
        <p>
            Showing {{$positions->firstItem()}} to {{$positions->lastItem()}} out of {{$positions->total()}} items
        </p>
        <p>
				{{$positions->links()}}
              </div>
