 <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Data POH</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" style="height: 460px;">
                <table class="table table-head-fixed text-nowrap">
                  <thead>
                    <tr>
                       <th wire:click="sortBy('name')" style="cursor:pointer;">POH @include('partials._sort-icon',['field'=>'name'])</th>
                  ...
                  <tbody>
								@forelse ($pohs as $item)
                                    <tr>
										...
										<td><a type="button" wire:click="$emitTo('master.poh.update','updatePoh',{{$item->id}})"  title="Ubah"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp; 
									        <a type="button" wire:click="$emitTo('master.poh.delete','deletePoh',{{$item->id}})" title="Hapus"><i class="fa fa-trash"></i></a>
									</td>
                                    </tr>
								@empty
									Data tidak ada!
        ...
        <p>
            Showing {{$pohs->firstItem()}} to {{$pohs->lastItem()}} out of {{$pohs->total()}} items
        </p>
        <p>
				{{$pohs->links()}}
              </div>
