                  ...
                  <tbody>
								@forelse ($employees as $item)
                                    <tr>
										...
										<td><a type="button" href="{{route('employee.edit',$item->id)}}"  title="Ubah"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp; 
									        <a type="button" wire:click="$emitTo('master.employee.delete','deleteEmployee',{{$item->id}})" title="Hapus"><i class="fa fa-trash"></i></a>
									</td>
                                    </tr>
								@empty
									Data tidak ada!
