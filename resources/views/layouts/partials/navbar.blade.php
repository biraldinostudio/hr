  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        @if(Auth::user()->level=='administrator' or Auth::user()->level=='hrd_admin')<a href="{{route('report-export')}}" class="nav-link"><i class="fa fa-file-excel"></i> Export Data</a>@endif
      </li>
    </ul>
